    ...
    >
      <div className="max-w-md md:max-w-4xl lg:max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative h-64 md:h-80 lg:h-96 rounded-xl overflow-hidden border border-stone-800 order-2 md:order-1">
            <Image
            ...
            <div className="absolute bottom-4 left-4">
              <span className="text-amber-500 text-xs md:text-sm tracking-wider uppercase">Valencia, España</span>
            </div>
          </div>
          
          <div className="order-1 md:order-2">
            <div className="text-center md:text-left mb-6 md:mb-10">
              <span className="text-amber-500 text-xs md:text-sm tracking-widest uppercase">Nuestra Historia</span>
            </div>
            
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white text-center md:text-left leading-tight mb-6 md:mb-8">
              Pasión por el{' '}
            ...
            <p className="text-stone-400 text-base md:text-lg leading-relaxed mb-8 md:mb-10">
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6">
              {[
                ...
                <div key={i} className="p-4 md:p-6 bg-stone-900 rounded-xl border border-stone-800 text-center">
                  <span className="block text-2xl md:text-3xl lg:text-4xl font-serif text-amber-500 mb-1">
                    {stat.number}
                  </span>
                  <span className="text-stone-500 text-xs md:text-sm uppercase tracking-wider">{stat.label}</span>
                </div>
              ))}
            </div>
          </div>
